...
export const hero: HeroContent = {
  ...
  h1: site.spine,
  sub: 'I\'ve spent 16 years commercializing data and tech for content and media businesses, and now I help commercial leaders who want to take control of AI.',
  channel: {
