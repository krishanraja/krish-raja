...
const locations = [
  ...
  { city: 'New York', period: '2024-2026', role: 'From career to full-stack portfolio', story: 'Now in Brooklyn, operating an autonomous AI business and advising companies commercializing theirs.' },
];
